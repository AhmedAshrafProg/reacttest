                         ...
                         <Container>
                              <Row>
                                   <Col className="p-2" lg={3} md={3} sm={6} >
                                        ...
                                        <a href="https://www.google.com" className='facebook social'><i className="fab mt-4 m-2 h4 fa-facebook"></i></a>
                                        <a href="https://www.google.com" className='facebook social'><i className="fab m-2 h4 fa-instagram"></i></a>
                                        <a href="https://www.google.com" className='facebook social'><i className="fab m-2 h4 fa-twitter"></i></a>
                                        <a href="https://www.google.com" className='facebook social'><i className="fab m-2 h4 fa-linkedin"></i></a>
                                        <a href="https://www.google.com" className='facebook social'><i className="fab m-2 h4 fa-youtube"></i></a>
                                   </Col>
                                   <Col className="p-2" lg={3} md={3} sm={6} >
                                        <h5 className="footer-menu-title">More Information </h5>
                                        <a href="https://www.google.com" className="footer-link" >purchase policy</a ><br></br>
                                        <a href="https://www.google.com" className="footer-link"> Privcey policy</a ><br></br>
                                        <a href="https://www.google.com" className="footer-link" > Refund Policy </a ><br></br>
                                   </Col>
                                   <Col className="p-2" lg={3} md={3} sm={6} >
