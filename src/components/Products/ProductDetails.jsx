...
import main_img from '../../assets/images/1.jpg'
import one_img from '../../assets/images/2.jpg'
import two_img from '../../assets/images/3.jpg'
import three_img from '../../assets/images/4.jpg'
import four_img from '../../assets/images/5.jpg'
...
export class ProductsDetails extends Component {
     ...
     render() {
          ...
          return (
               <Fragment>
                    <Container fluid={true} className='ms-5'>
                                        ...
                                        <Row className="p-2">
                                             <Col md={2} lg={2} sm={12} xs={12} >
                                                  <Col className="p-0 m-0" >
                                                       <img alt="" onClick={this.imgOnClick} className="smallimage product-sm-img"  src={one_img} />
                                                  </Col>
                                                  <Col className="p-0 m-0" md={12} lg={12} sm={3} xs={3}>
                                                  <img alt="" onClick={this.imgOnClick} className="smallimage product-sm-img"  src={two_img} />
                                                  </Col>
                                                  <Col className="p-0 m-0" md={12} lg={12} sm={3} xs={3}>
                                                  <img alt="" onClick={this.imgOnClick} className="smallimage product-sm-img"  src={three_img} />
                                                  </Col>
                                                  <Col className="p-0 m-0" md={12} lg={12} sm={3} xs={3}>
                                                  <img alt="" onClick={this.imgOnClick} className="smallimage product-sm-img"  src={four_img} />
                                                  </Col>
                                             </Col>
                                             <Col md={10} lg={10} sm={12} xs={12}>
                                                  <InnerImageZoom className="main-image" zoomType={"hover"} zoomScale={1.5} src={this.state.previewImg} />
                                             </Col>
                                        </Row>
                                   </Col>
                                   <Col className="p-3 " md={6} lg={6} sm={12} xs={12}>
